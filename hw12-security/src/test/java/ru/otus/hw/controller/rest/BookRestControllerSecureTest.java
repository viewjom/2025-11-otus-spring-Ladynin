...
class BookRestControllerSecureTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "/api/books, user, ROLE_USER, 200",
            "/api/books, admin, ROLE_ADMIN, 200",
            "/api/books/1, user, ROLE_USER, 200",
            "/api/books/2, user, ROLE_USER, 200",
            "/api/books/3, user, ROLE_USER, 200"
    })
    ...
    @ParameterizedTest
    @CsvSource({
            "/api/books, user, ROLE_USER, 403, Test1",
